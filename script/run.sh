...
echo "[ Expected completion time: around 17.2 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 12.9 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 5.5 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 1.2 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 0.9 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 6.6 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 4.0 hours ]" >> script/progress.txt
...
echo "[ Expected completion time: around 1.6 hours ]" >> script/progress.txt
